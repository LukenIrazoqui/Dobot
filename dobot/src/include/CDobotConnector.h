...
private:
    ...
    Q_INVOKABLE void connectDobot(void *isFinishedAddr, void *resultAddr, void *portNameAddr, unsigned int baudrate, void *fwTypeAddr, void *versionAddr, void *timeAddr);
    Q_INVOKABLE void disconnectDobot(void *isFinishedAddr, void *resultAddr);
    Q_INVOKABLE void getMarlinVersion(void *isFinishedAddr, void *resultAddr);
private:
